...
describe('Header', () => {
    ...
    describe('render', () => {
        ...
        it('renders nav links in drop down when trucks are available', () => {
            ...
            assert.deepEqual(menuItems[0].props.eventKey, truck_one, 'eventKey of the first Menu Item was set to truck_one');
            ...
            assert.deepEqual(menuItems[1].props.eventKey, truck_two, 'eventKey of the second nav link was set to truck_two');
